"""Structured logging setup using structlog wrapping stdlib logging.

Uses JSON rendering in production (LOG_FORMAT=json) and console rendering
in development (LOG_FORMAT=console, default).
"""
